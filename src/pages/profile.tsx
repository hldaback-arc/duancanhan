...
type User = { fullName: string; email: string; phone: string; approvalStatus?: "pending" | "approved" | "rejected"; managementRole?: "none" | "operator" | "manager" };
